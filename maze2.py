...
lose = font.render('YOU LOSE!', True, (215, 215, 0))
...
mixer.music.play()
kick = mixer.Sound('inecraft_death.ogg')
kick1 = mixer.Sound('muzyika-s-proydennoy-missiey-iz-gta-san-andreas.ogg')
kick.play()
